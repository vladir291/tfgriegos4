...
public class EditSeveralTimesActivity extends AppCompatActivity {
    // Declaramos los elementos
    private EditText nombreEt;
    private EditText inicioEt;
    private EditText finEt;
    private Integer irrigationId;
    private Irrigation riego;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        riego =(Irrigation) getIntent().getSerializableExtra("riego");
    ...
    private class EditarSeveralTimesDaySchedule extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try{
                ...
                errores = SeveralTimesDayScheduleUtils.compruebaErrores(EditSeveralTimesActivity.this);
                if(errores.size()==0){
        ...
        protected void onPostExecute(Void result){
            ...
            errores = SeveralTimesDayScheduleUtils.compruebaErrores(EditSeveralTimesActivity.this);
            SeveralTimesDayScheduleUtils.visualizaErrores(EditSeveralTimesActivity.this,errores);
            ...
            if(errores.size()>0){
                ...
                Intent intent = new Intent (EditSeveralTimesActivity.this, ListFarmsActivity.class);
